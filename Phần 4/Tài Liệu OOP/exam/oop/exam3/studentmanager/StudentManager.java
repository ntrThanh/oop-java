...
public class StudentManager {
    ...
    public List<Student> sortPhysicsGradeIncreasing() {
        /* TODO */
        return studentList.stream()
                .sorted(Comparator.comparing(Student::getPhysicsGrade))
                .collect(Collectors.toList());
    }
    ...
    public List<Student> sortPhysicsGradeDecreasing() {
        /* TODO */
        return studentList.stream()
                .sorted(Comparator.comparing(Student::getPhysicsGrade).reversed())
                .collect(Collectors.toList());
    }
    ...
    public List<Student> sortChemistryGradeIncreasing() {
        /* TODO */
        return studentList.stream()
                .sorted(Comparator.comparing(Student::getChemistryGrade))
                .collect(Collectors.toList());
    ...
    public List<Student> sortChemistryGradeDecreasing() {
        /* TODO */
        return studentList.stream()
                .sorted(Comparator.comparing(Student::getChemistryGrade).reversed())
                .collect(Collectors.toList());
    }
